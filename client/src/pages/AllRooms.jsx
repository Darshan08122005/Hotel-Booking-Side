  ...
  return (
    <div className="pt-28 px-4 md:px-16 lg:px-24 xl:px-32">
      <div className="flex flex-col items-start text-left mb-10">
        ...
        <p className="text-sm md:text-base text-gray-500/90 mt-2 max-w-[520px]">
      ...
      <div className="lg:grid lg:grid-cols-[1fr_360px] lg:gap-10">
        ...
        <aside className="bg-white w-full border border-gray-200 text-gray-600 mt-8 lg:mt-0 lg:sticky lg:top-28">
          <div
            className={`flex items-center justify-between px-5 py-2.5 ${
              openFilters ? 'border-b border-gray-200' : ''
            } `}
          >
