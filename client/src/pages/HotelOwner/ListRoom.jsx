...
const ListRoom = () => {
  ...
  return (
    ...
    <div>
      <Title align='left' font='outfit' title='Room Listings' subTitle='View , edit, or manage all listed room. Keep the information up-tp-date to provide the best experience for user.'/>
      <p className='text-gray-500 mt-8'>All Rooms</p>
      <div className='w-full max-w-3xl text-left border border-gary-300 rounded-lg max-h-80 overflow-y-scroll mt-3'>
        <table className='w-full'>
            <thead className='bg-gray-50'>
               <tr>
                <th className='py-3 px-4 text-gray-800 f0nt-medium'>Name</th>
                <th className='py-3 px-4 text-gray-800 f0nt-medium max-sm:hidden'>FAcility</th>
                <th className='py-3 px-4 text-gray-800 f0nt-medium '>Price  / night</th>
                <th className='py-3 px-4 text-gray-800 f0nt-medium text-center'>Actions</th>
               </tr>
            </thead>
